...
namespace StateEngine {
    ...
    public class DifficultyData {
        ...
        private static List<DifficultyValues> Load(TextAsset xmlFile) {
            //List<DifficultyValues> values = LoadDifficultyValues(VALUES_XML);
            List<DifficultyValues> values = LoadDifficultyValues(xmlFile);
            if (values.Count == 0) {
        ...
        private static List<DifficultyValues> LoadDifficultyValues(TextAsset xmlFile) {
